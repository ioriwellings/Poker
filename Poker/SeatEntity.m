...
-(void)dissWaittingView
{
    if([[UserInfo sharedUser].userID isEqualToString:self.player.playerID])
    {
        [[NSNotificationCenter defaultCenter] postNotificationName:ClosePlayerActionNotification object:self];
    }
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:ShowPlayerActionNotification object:self userInfo:nil];
